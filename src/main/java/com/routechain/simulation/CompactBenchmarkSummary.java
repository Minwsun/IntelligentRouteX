...
public record CompactBenchmarkSummary(
        ...
        List<String> regimes,
        java.util.Map<String, String> decisionOutcomeStageSemantics,
        String kpiTruthStage,
        String weightUpdateStage,
        String calibrationAggregateMethod,
        ...
        java.util.Map<String, Double> selectedPlanTypeShare,
        java.util.Map<String, Integer> routeSourceCounts,
        int compactBatchEligibleContexts,
        int compactBatchChosenWhenEligibleContexts,
