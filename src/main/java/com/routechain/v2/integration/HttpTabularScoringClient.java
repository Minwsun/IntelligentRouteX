...
public final class HttpTabularScoringClient implements TabularScoringClient {
    ...
    private WorkerReadyState bootstrapReadyState(Path manifestPath) {
        ...
        TabularWorkerManifest.TabularWorkerManifestEntry worker = manifest.worker(WORKER_NAME);
        if (worker == null) {
        ...
        try {
            TabularWorkerVersionResponse versionResponse = readJson("version", TabularWorkerVersionResponse.class, bootstrapTimeout);
            ...
            TabularWorkerReadyResponse readyResponse = readJson("ready", TabularWorkerReadyResponse.class, bootstrapTimeout);
