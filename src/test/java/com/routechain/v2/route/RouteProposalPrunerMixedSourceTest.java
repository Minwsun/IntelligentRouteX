...
class RouteProposalPrunerMixedSourceTest {

    @Test
    void retainsMixedSourcesWithSameStopOrderAsDistinctCandidates() {
        RouteChainDispatchV2Properties properties = RouteChainDispatchV2Properties.defaults();
        properties.getCandidate().setMaxRouteAlternatives(3);
        ...
        List<RouteProposalCandidate> retained = pruner.prune(List.of(
                ...
                candidate("proposal-b", tupleKey, pickupAnchor, driverCandidate, RouteProposalSource.ML_PROPOSAL, List.of("order-1", "order-2"), 0.79),
                candidate("proposal-c", tupleKey, pickupAnchor, driverCandidate, RouteProposalSource.ML_REFINED, List.of("order-1", "order-2"), 0.78)));
