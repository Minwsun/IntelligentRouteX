...
class BundleScorerTest {
    ...
    void deterministicScoreIsStableAndUrgencyGetsLift() {
        ...
        BundleCandidate urgent = new BundleCandidate("bundle-candidate/v1", "u", BundleFamily.URGENT_COMPANION, "cluster-001", false, List.of(), List.of("order-1", "order-3"), "order-1|order-3", "order-1", "0:0", 0.0, true, List.of());
        BundleCandidate compact = new BundleCandidate("bundle-candidate/v1", "c", BundleFamily.COMPACT_CLIQUE, "cluster-001", false, List.of(), List.of("order-1", "order-3"), "order-1|order-3", "order-1", "0:0", 0.0, true, List.of());
