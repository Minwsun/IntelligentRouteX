...
class EtaUncertaintyEstimatorTest {
    ...
    void freshInputsProduceLowerUncertainty() {
        ...
        double fresh = estimator.estimate(
                ...
                new WeatherContextSnapshot("weather-context-snapshot/v1", 1.0, false, WeatherSource.REQUEST_PROFILE, 0L, 1.0, 0L, ""),
                true,
                true,
                new FreshnessMetadata("freshness-metadata/v1", 0L, 0L, 0L, true, true, true));
        double stale = estimator.estimate(
                new TrafficProfileSnapshot("traffic-profile-snapshot/v1", 1.0, TrafficProfileSource.DEGRADED_PROFILE, 1000L, 0.4, false, "traffic-stale"),
                new WeatherContextSnapshot("weather-context-snapshot/v1", 1.0, false, WeatherSource.DEGRADED_PROFILE, 1000L, 0.3, 0L, "weather-stale"),
                false,
                false,
